...
// On crée ce client à l'intérieur de la fonction (pas au chargement
// du module) pour que l'absence de la clé en environnement ne fasse
// pas planter tout le déploiement si Stripe n'est pas encore configuré.
