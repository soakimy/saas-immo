...
export default function PropertyForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = isEditing
      ? await supabase.from("properties").update(payload).eq("id", existingProperty.id)
      : await supabase.from("properties").insert({ ...payload, agency_id: agencyId });
    ...
    router.push(isEditing ? `/dashboard/biens/${existingProperty.id}` : "/dashboard/biens");
    router.refresh();
  }
