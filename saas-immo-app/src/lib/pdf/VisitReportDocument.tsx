...
// toLocaleString("fr-FR") n'est pas fiable dans le moteur de rendu de
// react-pdf selon l'environnement serverless ; on formate donc le nombre
// nous-mêmes pour garantir un espace tous les 3 chiffres, sans dépendre d'Intl.
        ...
        <View style={styles.section}>
          ...
          {props.propertyPrice && (
            <View style={styles.row}>
              ...
              <Text style={styles.value}>{formatPrice(props.propertyPrice)}</Text>
            </View>
          )}
        </View>
